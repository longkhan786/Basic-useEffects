...
import tharMarusthal from './assets/TharMarusthal.png';
...
export const AVAILABLE_PLACES = [
  ...
  {
    id: "p19",
    title: "Thar Marusthal",
    image: {
      src: tharMarusthal,
      alt: "A view of the vast Thar Desert in Jaisalmer, Rajasthan.",
    },
    lat: 27.4695, // Replace with the actual latitude of Thar Desert
    lon: 70.6217,
  },
];
